...
class Credits extends Phaser.State {
	...
	create() {
	    ...
	    this.credits = new MenuButton(this.game, this.game.width/2, this.game.height, 
	    	"\n\nZASLUGE\n\n"+
	    	"Igru dizajnirao i izradio Ante Barić\n"+
	    	"Razvojna okolina: Phaser\n"+
	    	"\nZAHVALE\n\n"+
	    	"Fabijan Barić, glavni tester\n"+
	    ...
	    this.back = new MenuButton(this.game, this.game.width/2, 100, "Nazad", this.mainMenu);
	}
