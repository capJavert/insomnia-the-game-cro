...
class Main extends Phaser.State {
    ...
    create() {
        ...
        this.orbCountDisplay = new MenuButton(
            this.game, this.game.width-200, 60, "Kugle: "+this.game.orbCount, null, 
            {
                font: 'Arial',
                fontWeight: 'normal',
                fontSize: 28,
        ...
        this.healthDisplay = new MenuButton(
            this.game, 200, 60, "Životi: "+this.game.health, null, 
            {
                font: 'Arial',
                fontWeight: 'normal',
                fontSize: 28,
    ...
    update() {
        ...
        if(this.game.cursors.interact.esc.isDown) {
            this.game.ready = false;
            this.showLoadingMessage("... Učitavanje ...", this.mainMenu);

            return;
        }

        //update orb count display
        this.orbCountDisplay.text.setText("Kugle: "+this.game.orbCount);

        //update health display
        this.healthDisplay.text.setText("Životi: "+this.game.health);
        ...
        if(this.game.end) {
            ...
            if(this.game.lvlId==this.game.lastLvlId) {
                this.showLoadingMessage("... Probudi se!! ...", this.gameEnd);
            } else {
                this.showLoadingMessage("... Učitavanje ...", this.gameEnd);
            }
        ...
        if(!this.game.health) {
            ...
            this.showLoadingMessage("... Učitavanje ...", this.gameOver);
